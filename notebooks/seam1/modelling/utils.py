...
def fixed_to_fixed_streamer(sx, rx, data, nrec_streamer=200, ioffrec_streamer=0):
    ...
    for isrc in range(nsrc):
        ...
        data_streamer[isrc] = data[isrc, irec - ioffrec_streamer - nrec_streamer:irec - ioffrec_streamer]
